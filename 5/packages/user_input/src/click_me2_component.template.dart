...
AppView<import1.ClickMe2Component> viewFactory_ClickMe2Component0(AppView<dynamic> parentView, int parentIndex) {
...
class _ViewClickMe2ComponentHost0 extends AppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _ClickMe2Component_0_5 = new import1.ClickMe2Component();
    _compView_0.create(_ClickMe2Component_0_5, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.ClickMe2Component>(0, this, rootEl, _ClickMe2Component_0_5);
  }
...
AppView viewFactory_ClickMe2ComponentHost0(AppView<dynamic> parentView, int parentIndex) {
...
void initReflector() {
  ...
  _ngRef.registerComponent(ClickMe2Component, ClickMe2ComponentNgFactory);
  _ref0.initReflector();
}
