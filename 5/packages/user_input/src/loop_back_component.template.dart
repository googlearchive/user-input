...
class _ViewLoopBackComponentHost0 extends AppView<dynamic> {
  ...
  import1.LoopBackComponent _LoopBackComponent_0_4;
  ...
  ComponentRef build() {
    ...
    _LoopBackComponent_0_4 = new import1.LoopBackComponent();
    _compView_0.create(_LoopBackComponent_0_4, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.LoopBackComponent>(0, this, rootEl, _LoopBackComponent_0_4);
  }

  @override
  dynamic injectorGetInternal(dynamic token, int nodeIndex, dynamic notFoundResult) {
    if ((identical(token, import1.LoopBackComponent) && (0 == nodeIndex))) {
      return _LoopBackComponent_0_4;
    }
